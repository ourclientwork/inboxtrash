...
@section('content')
    ...
    <x-breadcrumb col="col-12 col-xl-8 col-xxl-8" title='Sidebar Menus' goTo="{{ route('admin.menus.sidebar.create') }}">
        <div class="col-auto">
            <form action=" {{ route('admin.menus.sidebar') }}" class="select2-sm" method="GET">
                            ...
                            @foreach ($menus as $menu)
                                <li class="dd-item" data-id="{{ $menu->id }}">
                                    ...
                                    <div class="handle row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <a href="{{ route('admin.menus.sidebar.edit', $menu->id) }}"

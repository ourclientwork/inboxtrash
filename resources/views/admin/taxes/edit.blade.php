...
@section('content')
    <x-breadcrumb title='ُEdit Tax' col="col-12 col-xl-8 col-xxl-8" backTo="{{ route('admin.taxes.index') }}" />
    <div>
                    ...
                    <div class="col">
                        <div class="box">
                            <form action="{{ route('admin.taxes.update', $tax->id) }}" method="POST">
                                ...
                                <div class="row row-cols-1 g-3">
                                    <div class="col">
                                        <x-input name='name' required label="Name" value="{{ $tax->name }}" />
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="col">
                                        <x-input step="0.01" min="0" max="100" type='number' name='rate'
                                            required label="Rate" value="{{ $tax->rate }}" />
                                    </div>
                                    <div class="col">

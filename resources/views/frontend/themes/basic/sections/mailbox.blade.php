        ...
        <div class="section-inner ">
            <div class="section-header">
                <div class="section-title-sm">
                    <span>{{ translate('MailBox') }}</span>
                </div>
                <h2 class="section-title">{{ translate('MailBox Title') }}</h2>
            ...
            <div class="mailbox-container ">
                ...
                <div class="mail-content" data-aos="fade-up">
                    ...
                    <div class="mailbox-ctr mt-4">
                        <h5> {{ translate('Need to save email address, custom domain and more ?') }} <a
                                href="{{ route('login') }}"> {{ translate('Login') }}
                            </a></h5>
                    </div>
